...
module.exports.render = function (context, modelIn) {
    ...
    switch (content.fontface) {
        case 'Euclid':
            model.fontface = ' font-family-euclid';
            break;
        case 'Graphik':
            model.fontface = ' font-family-graphik';
            break;
        case 'Gascogne':
            model.fontface = ' font-family-gascogne';
            break;
        default:
            model.fontface = '';
            break;
    ...
    return new Template("experience/components/commerce_assets/text").render(
        model
    ).text;
};
