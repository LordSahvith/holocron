...
/******/ 	return __webpack_require__(__webpack_require__.s = "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/flowersequence.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/flowersequence.js":
/*!****************************************************************************************************!*\
  !*** ./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/flowersequence.js ***!
  \****************************************************************************************************/
/*! no exports provided */
...
function ShoppingGallery(section) {
    ...
    this.loadImages = () => {
        if (this.type === "flower") {
            this.sequenceContainers.forEach((container) => {
                ...
                if (gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].getProperty(container, "display") === "none") return;

                const imgs = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.toArray(container.querySelectorAll("img"));
                ...
                gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["ScrollTrigger"].create({
                    ...
                    onUpdate: (self) => {
                        ...
                        if (newIndex !== currImg) {
                            gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(imgs[currImg], { display: "none" });
                            gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(imgs[newIndex], { display: "inline" });
                            currImg = newIndex;
                        }
                    }
                });
                ...
                imgs[0].addEventListener("load", () => gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["ScrollTrigger"].refresh());
            });
    ...
    this.resize = () => {
        if (innerWidth < 500) {
            gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(".flower-sequence", { y: this.text.offsetHeight / 2 });
        } else {
            gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(".flower-sequence", { clearProps: "y" });
        }
    };
...
/******/ });
//# sourceMappingURL=flowersequence.js.map