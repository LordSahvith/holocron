...
/******/ 	return __webpack_require__(__webpack_require__.s = "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/lighting/dragcompare.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/lighting/dragcompare.js":
/*!**********************************************************************************************************!*\
  !*** ./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/lighting/dragcompare.js ***!
  \**********************************************************************************************************/
/*! no exports provided */
...
gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].registerPlugin(gsap_Draggable__WEBPACK_IMPORTED_MODULE_2__["Draggable"]);

const PRM = window.matchMedia('(prefers-reduced-motion: reduce)').matches;

let minXPercent = 10;
let maxXPercent = 100 - minXPercent;
let clampPercent = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.clamp(minXPercent, maxXPercent);
...
function Bright360DragCompare(section) {
    ...
    if(!PRM) {
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].from(section, {
            "--x": `${maxXPercent}%`,
            duration: 2,
            ease: "power3.inOut",
            scrollTrigger: {
    ...
    const resize = () => {
        ...
        if(innerWidth > 1024) {
            ...
            clampPercent = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.clamp(minXPercent, maxXPercent);
        } else {
            minXPercent = 10;
            maxXPercent = 100 - minXPercent;
            clampPercent = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.clamp(minXPercent, maxXPercent);
    ...
    const updateX = x => {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to(section, {
            "--x": `${ percent }%`,
            duration: 0.1,
            overwrite: true
        });
    ...
    let draggable = gsap_Draggable__WEBPACK_IMPORTED_MODULE_2__["Draggable"].create(this.dragProxy, {
        type: "x",
        trigger: comparison,
        onDrag: function(e) {
...
/******/ });
//# sourceMappingURL=dragcompare.js.map