...
/******/ 	return __webpack_require__(__webpack_require__.s = "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/machine/autopress/sequence.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/machine/autopress/sequence.js":
/*!****************************************************************************************************************!*\
  !*** ./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/machine/autopress/sequence.js ***!
  \****************************************************************************************************************/
/*! no exports provided */
    ...
    */
    ...
    this.setText = (text, progress, inStart, inStop, outStart, outStop) => {
        if (progress < inStart || progress >= outStop) {
            ...
            const eased = gsap__WEBPACK_IMPORTED_MODULE_0__["Power1"].easeOut(normalized);
            ...
            const eased = gsap__WEBPACK_IMPORTED_MODULE_0__["Power1"].easeIn(normalized);
    ...
    */
    ...
    this.onAnimationFrame = () => {
        ...
        if (this.progress < 0.05) {
            ...
            const eased = gsap__WEBPACK_IMPORTED_MODULE_0__["Power1"].easeInOut(normalized);
