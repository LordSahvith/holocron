...
/******/ 	return __webpack_require__(__webpack_require__.s = "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/machine/easypress/toggle.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/machine/easypress/toggle.js":
/*!**************************************************************************************************************!*\
  !*** ./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/machine/easypress/toggle.js ***!
  \**************************************************************************************************************/
/*! no exports provided */
...
function EasypressToggle(section) {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set([this.firstVisual, this.secondVisual], {
        xPercent: -50,
        yPercent: -50
    });
    ...
    const toggleAnimation = (outVars, inVars, heightDiff) => {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to(this.toggleContainer, {
            y: heightDiff,
            duration: 0.2,
            overwrite: true
        });
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to([outVars.text, outVars.visual], {
            autoAlpha: 0,
            duration: 0.2,
            overwrite: true,
            onComplete: () => {
                // Set out properties
                gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set([outVars.text, outVars.visual], { display: "none" });
                gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(outVars.visual, { scale: PRM ? 1 : 1.2 });

                // Clear y transform on toggle container
                gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(this.toggleContainer, { y: 0 });

                // Animate in
                gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set([inVars.text, inVars.visual], { display: "block" });
                if(PRM) gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(inVars.visual, { scale: 1 });

                gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to(inVars.text, {
                    autoAlpha: 1,
                    stagger: 0.05
                });
                gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to(inVars.visual, {
                    autoAlpha: 1,
                    scale: 1,
                    duration: 0.25
                });
    ...
    this.resize = () => {
        const firstDisplay = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].getProperty(this.firstTextTargets[0], "display");
        const secondDisplay = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].getProperty(this.secondTextTargets[0], "display");

        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set([this.firstTextTargets, this.secondTextTargets], { display: "block" });
        this.heightDiff = this.firstText.offsetHeight - this.secondText.offsetHeight;

        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(this.textContainer, {
            height: Math.max(this.firstText.offsetHeight, this.secondText.offsetHeight) + this.toggleContainer.offsetHeight + gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].getProperty(this.toggleContainer, "marginTop")
        });

        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(this.firstTextTargets, { display: firstDisplay });
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(this.secondTextTargets, { display: secondDisplay });
    };
