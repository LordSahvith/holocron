...
/******/ 	return __webpack_require__(__webpack_require__.s = "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/machine/joy/cards.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/machine/joy/cards.js":
/*!*******************************************************************************************************!*\
  !*** ./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/machine/joy/cards.js ***!
  \*******************************************************************************************************/
/*! no exports provided */
...
$(document).ready(function () {
    ...
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["ScrollTrigger"].matchMedia({
        ...
        "(min-width: 1025px)": () => {
            ...
            if (!hasFired) {
                gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].from(cards, {
                    duration: 1,
                    opacity: 0,
                    stagger: 0.1,
                    scrollTrigger: {
        ...
        "(max-width: 1024px)": () => {
            // Fade in of the cards
            if (!hasFired) {
                gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(cards, { autoAlpha: 0, y: PRM ? 0 : 50 });

                gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["ScrollTrigger"].batch(cards, {
                    start: "top 70%",
                    once: true,
                    onEnter: (batch) => {
                        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to(batch, {
                            autoAlpha: 1,
                            y: 0,
                            stagger: 0.1,
                            duration: 0.3
            ...
            let resize = () => {
                if (innerWidth < 1025) {
                    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(centerCol, { yPercent: 0 });
                    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set([leftCol, rightCol], { yPercent: 16.66 });
                }
            };
