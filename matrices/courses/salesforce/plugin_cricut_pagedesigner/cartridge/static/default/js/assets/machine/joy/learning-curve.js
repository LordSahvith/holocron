...
/******/ 	return __webpack_require__(__webpack_require__.s = "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/machine/joy/learning-curve.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/machine/joy/learning-curve.js":
/*!****************************************************************************************************************!*\
  !*** ./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/machine/joy/learning-curve.js ***!
  \****************************************************************************************************************/
/*! no exports provided */
...
function setDesktopPos(topRight, left, botRight) {
    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(topRight, { x: xDist, y: -375, xPercent: 0, yPercent: 0 });
    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(left, { x: -420, y: -70, xPercent: 0, yPercent: 0 });
    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(botRight, { x: xDist, y: 185, xPercent: 0, yPercent: 0 });
}
...
function setMobilePos(topRight, left, botRight) {
    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(topRight, { x: 0, y: 0, xPercent: 105, yPercent: -135 });
    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(left, { x: 0, y: 0, xPercent: -205, yPercent: -50 });
    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(botRight, { x: 0, y: 0, xPercent: 105, yPercent: 80 });
}
...
function resize() {
    ...
    if (innerWidth > phoneBreakpoint && !hasFired) {
        ...
        introAnim = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline({
            scrollTrigger: {
                trigger: visuals,
                start: "center 70%",
                once: true,
...
function JoyLearningCurve() {
    ...
    resize();
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["ScrollTrigger"].addEventListener("refresh", resize);
...
/******/ });
//# sourceMappingURL=learning-curve.js.map