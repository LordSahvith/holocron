...
/******/ 	return __webpack_require__(__webpack_require__.s = "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/zoom-sequence.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/zoom-sequence.js":
/*!***************************************************************************************************!*\
  !*** ./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/assets/zoom-sequence.js ***!
  \***************************************************************************************************/
/*! no exports provided */
...
function MachineZoom(section) {
    ...
    this.setupSection = () => {
        ...
        // The arm animation
        const armSpeed = 0.1;
        const armAnim = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline({
            repeat: -1,
            yoyo: true
        });
        ...
        // The dash animation
        const dashAnim = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to(".speed-comparison path", {
            strokeDashoffset: 7,
            repeat: -1,
            ease: "none"
        });
        ...
        const scrollAnim = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline({
            scrollTrigger: {
        ...
        gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__["ScrollTrigger"].getAll().forEach(ST => {
            if (isAfterScrollST) {
                ST.refresh();
                return;
            }
    ...
    this.resize = () => {
        if (innerWidth < mobileBreakpoint) {
            const imageHeight = this.machineContainer.offsetHeight * gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].getProperty(this.machineContainer, "scale");
            gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(this.finalText, { bottom: imageHeight * 0.25 });
        } else {
            gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(this.finalText, { clearProps: "bottom" });
        }
    };
...
/******/ });
//# sourceMappingURL=zoom-sequence.js.map