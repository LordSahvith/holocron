...
/******/ 	return __webpack_require__(__webpack_require__.s = "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/components/editorialGallery.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/components/editorialGallery.js":
/*!**********************************************************************************************************!*\
  !*** ./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/components/editorialGallery.js ***!
  \**********************************************************************************************************/
/*! no exports provided */
...
function EditorialGalleryContainer(container) {
    ...
    if (loadMoreBtn) {
        ...
        loadMoreBtn.anim = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline({
            paused: true,
...
function galleryGroupLoader(group) {
    ...
    if (title) {
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].from(title, {
            opacity: 0,
            y: 50,
            scrollTrigger: {
                trigger: title,
...
let setupItemLoadAnims = (items) => {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(items, { y: "60vh" });
    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(itemCovers, {
        display: "block",
        backgroundColor: () => getRandomFrom(colors)
    });

    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].from(items, { opacity: 0, duration: 0.3 });
...
/******/ });
//# sourceMappingURL=editorialGallery.js.map