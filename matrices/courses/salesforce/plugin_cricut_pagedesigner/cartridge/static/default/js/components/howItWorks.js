...
/******/ 	return __webpack_require__(__webpack_require__.s = "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/components/howItWorks.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/components/howItWorks.js":
/*!****************************************************************************************************!*\
  !*** ./cartridges/plugin_cricut_pagedesigner/cartridge/client/default/js/components/howItWorks.js ***!
  \****************************************************************************************************/
/*! no exports provided */
...
function HowItWorksSection(section) {
    ...
    visuals.forEach((visual, i) => {
        ...
        visual.intro = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"]
            ...
            .add(() => { // The star and circle animations
                svgItems
                    .slice(0, gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.random([4, 5, 6])) // Choose 4, 5, or 6 of the items
                    .forEach((item) => {
                        // Give it a random fill, scale, and rotation
                        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].set(item, {
                            fill: gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.random(colors),
                            scale: gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.random(minScale, 1),
                            xPercent: -50,
                            yPercent: -50
                        });
                        ...
                        const endX = group.x + gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.random(0, maxItemOffsetPercent) * svgWidth;
                        const endY = group.y + gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.random(0, maxItemOffsetPercent) * svgHeight;
                        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].fromTo(
                            item,
                            {
                                x: (center.x - endX) * startDistPercent + endX,
                                y: (center.y - endY) * startDistPercent + endY,
                                rotation: gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.random(0, 72),
                                opacity: 0
                            },
                            {
                                x: endX,
        ...
        visual.outro = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"]
            .timeline({ paused: true })
            .set(visual, { zIndex: 0 })
            .fromTo(
                visual,
    ...
    let scrollAnim = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"]
        .timeline({
            scrollTrigger: {
                trigger: content,
                start: 'center center',
